...
with fileinput.FileInput(
    ...
    for line in input:
        ...
        massaged_line = re.sub(
            r"https://envirodiy.github.io/GroPointModbus/[\w/-]+\.html#enu_walk_(?P<section_name>[\w/-]+)",
            r"@ref menu_walk_\g<section_name>",
            massaged_line,
        )
        # for classes, we need to switch camel and snake cases
        class_link = re.search(
            r"https://envirodiy.github.io/GroPointModbus/(?:class)(?P<class_link>[\w/-]+)\.html",
            massaged_line,
        )
        ...
        group_link = re.search(
            r"https://envirodiy.github.io/GroPointModbus/(?:group__)(?P<group_link>[\w/-]+)\.html",
            massaged_line,
        )
        ...
        example_link = re.search(
            r"https://envirodiy.github.io/GroPointModbus/(?P<example_name>[\w/-]+)_8ino-example\.html",
            massaged_line,
        )
        ...
        massaged_line = re.sub(
            r"https://envirodiy.github.io/GroPointModbus/index.html#(?P<section_name>[\w/-]+)",
            r"@ref \g<section_name>",
            massaged_line,
        )
        massaged_line = re.sub(
            r"https://envirodiy.github.io/GroPointModbus/index.html",
            "@ref mainpage",
            massaged_line,
        )
        ...
        massaged_line = re.sub(
            r"https://envirodiy.github.io/GroPointModbus/(?P<section_name>[\w/-]+)\.html",
            r"@ref \g<section_name>",
            massaged_line,
        )
